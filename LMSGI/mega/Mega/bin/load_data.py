...
from Mega.data.languages import ProgrammingLanguage
from Mega.data.licenses import License
from Mega.data.maintainers import Maintainer
from Mega.data.package import Package
from Mega.data.releases import Release
from Mega.data.users import User
...
def init_db():
    ...
    rel_file = os.path.join('..', 'db', 'mega.sqlite')
